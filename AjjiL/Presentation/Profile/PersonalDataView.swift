    ...
    var body: some View {
            VStack(spacing: 0) {
                TopRowNotForHome(
                    ...
                    title: "Personal Data".newlocalized,
                    showBackButton: true,
                ...
                ScrollView {
                    VStack(spacing: 28) {
                        // 🛠️ FIX: Added .newlocalized
                        Text("Your Registration Data".newlocalized)
                            .font(.title3.bold())
                        ...
                        GreenButton(
                            // 🛠️ FIX: Added .newlocalized
                            title: model.isLoading ? " " : "Save".newlocalized,
            ...
            .toolbar {
                ToolbarItemGroup(placement: .keyboard) {
                    // 🛠️ FIX: Changed from .localized() to .newlocalized for consistency
                    Button("done".newlocalized) { focusedField = nil }
                    Spacer()
    ...
    var formFields: some View {
            VStack(spacing: 18) {
                CustomTextField(
                    ...
                    text: $model.username,
                    // 🛠️ FIX: Changed from .localized() to .newlocalized
                    placeholder: "username".newlocalized,
                ...
                CustomTextField(
                    ...
                    text: $model.email,
                    // 🛠️ FIX: Changed from .localized() to .newlocalized
                    placeholder: "email_placeholder".newlocalized,
...
struct SuccessSheetVieww: View {
    ...
    var body: some View {
        VStack(spacing: 32) {
            ...
            // 🛠️ FIX: Added .newlocalized
            Text("Saved Successfully".newlocalized)
            ...
            // 🛠️ FIX: Added .newlocalized
            GreenButton(title: "Done".newlocalized, action: {
